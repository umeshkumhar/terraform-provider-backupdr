...
var (
	_ resource.Resource                = &sltResource{}
	_ resource.ResourceWithConfigure   = &sltResource{}
	_ resource.ResourceWithImportState = &sltResource{}
)

// NewSltResource to create SLA Template
func NewSltResource() resource.Resource {
	return &sltResource{}
}

// sltResource is the resource implementation.
type sltResource struct {
	client  *backupdr.APIClient
	authCtx context.Context
}

// Metadata returns the resource type name.
func (r *sltResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_slt"
}

// Schema defines the schema for the resource.
func (r *sltResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *sltResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *sltResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError(
			...
			"Could not update slt, unexpected error: "+err.Error(),
		)
		return
	}
...
func (r *sltResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
