...
var (
	_ resource.Resource                = &slpResource{}
	_ resource.ResourceWithConfigure   = &slpResource{}
	_ resource.ResourceWithImportState = &slpResource{}
)

// NewSlpResource to create SLA Profiles
func NewSlpResource() resource.Resource {
	return &slpResource{}
}

// slpResource is the resource implementation.
type slpResource struct {
	client  *backupdr.APIClient
	authCtx context.Context
}

// Metadata returns the resource type name.
func (r *slpResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_slp"
}

// Schema defines the schema for the resource.
func (r *slpResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *slpResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *slpResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	// Retrieve values from plan
	var plan SlpResourceModel
...
func (r *slpResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Get current state
...
func (r *slpResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	// Retrieve values from plan
	var plan SlpResourceModel
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
...
func (r *slpResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r *slpResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
