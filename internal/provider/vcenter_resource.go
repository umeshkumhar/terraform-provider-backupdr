...
var (
	_ resource.Resource                = &vcenterHostResource{}
	_ resource.ResourceWithConfigure   = &vcenterHostResource{}
	_ resource.ResourceWithImportState = &vcenterHostResource{}
)

// NewVcenterHostResource to create vCenter Host
func NewVcenterHostResource() resource.Resource {
	return &vcenterHostResource{}
}

// vcenterHostResource is the resource implementation.
type vcenterHostResource struct {
	client  *backupdr.APIClient
	authCtx context.Context
}

// Metadata returns the resource type name.
func (r *vcenterHostResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_vcenter"
}

// Schema defines the schema for the resource.
func (r *vcenterHostResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *vcenterHostResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *vcenterHostResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vcenterHostResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Get current state
...
func (r *vcenterHostResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	// Retrieve values from plan
	var plan vcenterHostRest
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
...
func (r *vcenterHostResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
...
func (r *vcenterHostResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
